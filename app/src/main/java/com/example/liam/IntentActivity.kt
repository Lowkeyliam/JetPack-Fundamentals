...
fun MyIntents (){
    Column (
        modifier = Modifier
            .fillMaxSize()
            .paint(
                painterResource(id = R.drawable.boom),
        ...
        OutlinedButton(
            onClick = {
                ...
                smsIntent.data="smsto:0706605553".toUri()
                smsIntent.putExtra("sms_body","Hello Liam,how was your day?")
        ...
        OutlinedButton(
            onClick = {
                ...
                shareIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf("liammaina870@gmail.com"))
